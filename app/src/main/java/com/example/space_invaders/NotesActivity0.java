...
public class NotesActivity0 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btMala.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                editor.putInt("notesActivityMode", 1);
        ...
        bt1.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                editor.putInt("notesActivityMode", 2);
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD) {
                    editor.apply();
                }
                openMainActivity();
        ...
        bt2.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                editor.putInt("notesActivityMode", 3);
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD) {
                    editor.apply();
                }
                openMainActivity();
